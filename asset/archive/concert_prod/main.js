...
//////////////////////////////////
    ...
    data: [
      ...
      {audio: 7, title: 'アルメニアンダンス・パートII', composer: 'Aリード'},
...
//////////////////////////////////
    ...
    data: [
      {title: '祝典序曲', composer: 'D.ショスタコーヴィチ'},
      {title: '夢', composer: 'C.ドビュッシー'},
      {title: 'シンフォニック・バンドのための序曲', composer: '兼田敏'},
      {title: '呪文と踊り', composer: 'J.B.チャンス'},
      {title: 'バレエ音楽「くるみ割り人形」より', composer: 'P.I.チャイコフスキー'},
      {title: '吹奏楽のための交響曲「メキシコの祭り」', composer: 'O.リード'},
    ]
  }, {
//////////////////////////////////
////// 第4回定期演奏会データ //////
...
//////////////////////////////////
    ...
    data: [
      {audio: 0, title: 'シンフォニア・ノビリッシマ', composer: 'R.ジェイガー'},
      {audio: 1, title: '天使の糧', composer: 'C.フランク'},
      {audio: 2, title: '吹奏楽のためのバーレスク', composer: '大栗裕'},
      {audio: 3, title: 'リシルド序曲', composer: 'G.バレ'},
      {audio: 4, title: 'バレエ音楽「白鳥の湖」より', composer: 'P.I.チャイコフスキー'},
      {audio: 14, title: 'ロマネスク', composer: 'J.スウェアリンジェン'},
      {audio: 15, title: 'ブロックM', composer: 'J.H.ビリック'}
    ]
  }, {
//////////////////////////////////
...
//////////////////////////////////
    ...
    data: [
      {audio: 0, title: '行進曲「フローレンティナー」', composer: 'J.フチーク'},
      {audio: 1, title: '組曲「キャンディード」', composer: 'L.バーンスタイン', movement: ['1. この世は限りなく最良のもの', '2. ウェストファリア・コラールと戦いの場面', '3. 判決', '4. きらびやかに楽しく', '5. 我らの庭を耕そう']},
      {audio: 6, title: 'デリー地方のアイルランド民謡', composer: 'P.A.グレンジャー'},
      {audio: 7, title: '歌劇「笛吹きシュワンダ」より ポルカとフーガ', composer: 'W.ワインベルガー'},
      {audio: 8, title: '道祖神の詩', composer: '福島弘和'},
      {audio: 9, title: 'をどり唄', composer: '柏崎真一'},
      {audio: 10, title: '英雄的音楽より', composer: 'G.P.テレマン', movement: ['No.5 Bellicoso', 'No.6 Amoroso', 'No.11 Risoluto']},
      {audio: 13, title: '霧の中の乙女', composer: 'H.L.クラーク'},
      {audio: 14, title: 'バレエ音楽「三角帽子」より', composer: 'M.ファリャ', movement: ['1. 隣人の踊り', '2. 粉屋の踊り', '3. 終幕の踊り']},
      {audio: 17, title: 'スターダスト～煙が目にしみる', composer: 'Hoagy Carmichae & Jerome Kern'},
...
//////////////////////////////////
    ...
    data: [
      ...
      {audio: 13, video: 11, title: 'アメージング・グレイス'},
...
//////////////////////////////////
    ...
    data: [
      ...
      {audio: 18, video: 18, title: 'アメージング・グレイス'},
...
//////////////////////////////////
    ...
    data: [
      ...
      {audio: 6, video: 6, title: 'アメージング・グレイス'},
...
//////////////////////////////////
    ...
    data: [
      ...
      {audio: 8, video: 8, title: 'ソング・フォー・ジャパン'},
      {audio: 9, video: 9, title: 'ブロックM', composer: 'J.H.ビリック'}
    ],
  }, {
//////////////////////////////////
