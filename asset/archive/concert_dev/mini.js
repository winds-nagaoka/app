...
////////////////////////////////////
    ...
    data: [
      {audio: 0, title: '前前前世', composer: 'RADWINPS', arranger: '宮川成治'},
      {audio: 1, title: '夢をかなえてドラえもん', composer: '黒須克彦', arranger: '本澤なおゆき'},
      {audio: 2, title: '名探偵コナン メインテーマ(Ver.1)', composer: '大野克夫', arranger: '宮川成治'},
      {audio: 3, title: 'ありがとう', composer: '水野良樹', arranger: '濱崎大吾'},
      {audio: 4, title: '恋', composer: '星野源', arranger: '郷間幹男'},
      {audio: 5, title: '花束を君に', composer: '宇多田ヒカル', arranger: '侘美秀俊'},
      {audio: 6, title: 'トランペット吹きの休日', composer: 'L.アンダーソン'},
      {audio: 7, title: 'ナイトバーズ', composer: 'SHAKATAK', arranger: '中川賢二'},
      {audio: 8, title: 'ジャパニーズ・グラフィティーIV～弾厚作 作品集～', composer: '弾厚作', arranger: '磯崎敦博'},
      {audio: 9, title: '勇気100％', composer: '馬飼野康二', arranger: '野崎雅久'},
      {audio: 10, title: 'DREAM SOLISTER', composer: '加藤裕介', add: ['アニメ「響け!ユーフォニアム」OP']}
    ]
  }, {
////////////////////////////////////
////// 2018年春のミニコンサート //////
