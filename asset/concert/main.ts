...
export const mainConcert: MainConcert[] = [
  ...
  },
  {
    ...
    data: [
      ...
      { audio: 4, title: '吹奏楽のための「エール・マーチ」', composer: '宮下秀樹' },
      {
        ...
        title: 'ローマの噴水',
        composer: 'O.レスピーギ',
        movement: ['夜明けのジュリアの谷の噴水', '朝のトリトンの噴水', '真昼のトレヴィの泉', '黄昏のメディチ荘の噴水'],
      },
  ...
  },
  {
    ...
    data: [
      ...
      { audio: 6, title: '天使の糧', composer: 'C.フランク', arranger: 'A.リード' },
      {
        audio: 7,
        title: '幻想交響曲より',
        composer: 'H.ベルリオーズ',
      ...
      { audio: 9, title: '目覚めよ、と呼ぶ声あり', composer: 'J.S.バッハ', arranger: 'A.リード' },
      { audio: 10, title: 'ブロックM', composer: 'J.H.ビリック' },
    ],
  },
]
