const sourceAudio = [
  ...
  // },
  {
    ...
    data: [
      ...
      {available: true, data: 3, path: 'slavonic46-2.mp3', addtitle: 'Op.46 No.2'},
      {available: true, data: 3, path: 'slavonic46-8.mp3', addtitle: 'Op.46 No.8'},
      {available: true, data: 3, path: 'slavonic72-2.mp3', addtitle: 'Op.72 No.2'},
